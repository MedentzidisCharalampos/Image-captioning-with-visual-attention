...
#To speed up training for this tutorial, you'll use a subset of 30,000 captions and their corresponding images to train our model.
...
#First, we tokenize the captions (for example, by splitting on spaces).
# This gives us a vocabulary of all of the unique words in the data (for example, "surfing", "football", and so on).

#Next, we limit the vocabulary size to the top 5,000 words (to save memory).
